...
var OpenStreetMap = Extendable.extend(function (self, opts) {
    ...
    :param integer address_limit:
        Maximum number of search results to return. Defaults to `3`0.

    :param array bounding_box:
        Bounding box to limit search results to. Defaults to
    ...
    */
    ...
    self.extract_address_label = opts.extract_address_label || function(result) {
        ...
        Extracts a human-friendly display name for an Open Street Map location
        result.
    ...
    self.extract_address = function(result) {
        ...
        Takes a result from the OpenStreetMap API and returns an address.
