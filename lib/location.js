...
var LocationState = State.extend(function(self, name, opts) {
    ...
    */
                ...
                if (isNaN(content)) {
                    switch(content) {
                        case 'n':
                            ...
                            if (++self.metadata.current_page >=
                            self.metadata.pages.length) {
                                self.metadata.current_page =
                                    self.metadata.pages.length-1;
                            }
                            // Set page text
                    ...
                    var address = self.metadata.pages[current_page_no]
                                    .options[content-1];   // Array 0-referenced
    ...
    self.store_contact_data = function(data) {
        self.contact.location_address = data;
        return self.im
