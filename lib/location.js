...
var LocationState = State.extend(function (self, name, opts) {
    ...
    :param array opts.address_details:
        Optional list for OpenStreetMaps that when passed in defines which
        address details will be displayed back to the user to select their
        address from (overrides ``display_name``). Defaults to ``[]``.
        Example:``['house_number', 'road', 'suburb', 'city', 'state', 'postcode',
        'country']``
    ...
    */
    ...
    opts = _.defaults(opts || {}, {
        ...
        store_fields: (
            (opts.mapping_service === 'gmaps' || opts.mapping_service === undefined) ?
    ...
    self.extract_from_osmaps = function(results) {
        ...
        results.forEach(function(res) {
            ...
            // Ensure that display_name is included as it is needed to
            // generate the pages.
